      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 p-6 md:p-10">
        <div className="max-w-3xl mx-auto">
          ...
          <Card className="border-none shadow-2xl">
            <CardHeader className={`p-8 bg-gradient-to-r ${module.color} text-white`}>
                    ...
                    {module.id === 'breathing' && (
                      <div className="mb-8">
                        <motion.div
                          ...
                          className="w-32 h-32 rounded-full bg-gradient-to-br from-blue-400 to-cyan-400 mx-auto"
                        />
                      </div>
                    )}
                  </motion.div>
                ...
                <div className="space-y-4">
                  {module.affirmations.map((affirmation, idx) => (
                    <motion.div
                      ...
                      className="p-6 bg-gradient-to-r from-rose-50 to-pink-50 rounded-lg border-2 border-rose-200"
                    >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 p-6 md:p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {mentalPrepModules.map(module => {
            ...
            return (
              ...
              >
                <CardHeader className={`p-6 bg-gradient-to-r ${module.color} text-white`}>
        ...
        <Card className="mt-12 border-none shadow-xl bg-gradient-to-br from-green-50 to-emerald-50">
          <CardContent className="p-8">
