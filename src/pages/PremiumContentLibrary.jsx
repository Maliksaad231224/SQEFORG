...
export default function PremiumContentLibrary() {
        ...
        <CardHeader className="pb-3">
          <div className="flex items-start justify-between mb-2 gap-2">
            <div className="flex-1 min-w-0">
              ...
              <CardTitle className="text-base leading-tight break-words">{item.title}</CardTitle>
            </div>
            {!canAccess && <Lock className="w-5 h-5 text-slate-400 flex-shrink-0" />}
          </div>
          {item.subject && (
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 p-4 sm:p-6 md:p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 mb-2 sm:mb-3 flex items-center gap-2 sm:gap-3">
            <BookOpen className="w-8 h-8 sm:w-10 sm:h-10 text-purple-600 flex-shrink-0" />
            <span className="break-words">Premium Content Library</span>
          </h1>
