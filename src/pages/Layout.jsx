          ...
          <Sidebar className="border-r border-slate-200 bg-white z-20">
            <SidebarHeader className="border-b border-slate-100 p-6">
              <div className="flex items-center gap-3">
                <div className="relative w-12 h-12 bg-gradient-to-br from-slate-800 via-slate-700 to-blue-900 rounded-xl flex items-center justify-center shadow-lg">
                      ...
                      <SidebarGroup key={group.label}>
                          ...
                          <SidebarGroupContent>
                              ...
                              {group.items.map((item) => {
                                  ...
                                  if (location.pathname === item.url.split('?')[0]) {
                                      itemClasses += " bg-gradient-to-r from-slate-800 to-blue-900 text-white hover:from-slate-700 hover:to-blue-800 shadow-md";
            ...
            <SidebarFooter className="border-t border-slate-100 p-4">
              <div className="bg-gradient-to-br from-slate-800 via-slate-700 to-blue-900 rounded-xl p-4 text-white shadow-lg mb-2 relative overflow-hidden">
