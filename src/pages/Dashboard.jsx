...
export default function Dashboard() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 p-10 flex items-center justify-center">
            ...
            <CardContent>
              <div className="grid md:grid-cols-4 gap-4">
                <Button
                  ...
                  className="h-20 flex-col bg-gradient-to-br from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700"
                >
                  <Target className="w-6 h-6 mb-2" />
                  Quick Practice
                </Button>
                <Button asChild className="h-20 flex-col bg-gradient-to-br from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700">
                  <Link to={createPageUrl("InteractivePractice")}>
                    <Brain className="w-6 h-6 mb-2" />
                    Interactive Quiz
                  </Link>
                </Button>
                <Button asChild className="h-20 flex-col bg-gradient-to-br from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700">
                  <Link to={createPageUrl("MockExams")}>
                    <BookOpen className="w-6 h-6 mb-2" />
                    Mock Exam
                  </Link>
                </Button>
                <Button asChild className="h-20 flex-col bg-gradient-to-br from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700">
