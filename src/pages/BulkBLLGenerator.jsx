        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 p-6 md:p-10">
            <div className="max-w-5xl mx-auto">
                <div className="mb-8 text-center">
                    <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-slate-800 to-blue-900 rounded-2xl flex items-center justify-center">
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid md:grid-cols-2 gap-4">
                                <Button
                                    ...
                                    className="h-auto py-6 flex-col bg-gradient-to-br from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700"
                                >
                                ...
                                <Button
                                    ...
                                    disabled={savedProgress}
                                    className="h-auto py-6 flex-col bg-gradient-to-br from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700"
                                >
                                    <Sparkles className="w-8 h-8 mb-2" />
