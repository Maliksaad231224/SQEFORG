                             ...
                             <div className="space-y-2 text-sm mb-4">
                                {['A', 'B', 'C', 'D', 'E'].map(opt => {
                                    ...
                                    <div key={opt} className={`flex items-start gap-3 p-3 rounded-lg border ${
                                        ...
                                        {isCorrectAnswer ? <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0"/> : isUserAnswer ? <XCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0"/> : <div className="w-5 h-5 flex-shrink-0" /> }
