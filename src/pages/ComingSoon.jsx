    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 p-6 md:p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <Card className="mb-12 border-2 border-purple-500 shadow-2xl">
          ...
          <CardHeader className="p-8 bg-gradient-to-br from-purple-500 to-indigo-600 text-white rounded-t-lg mt-4">
          ...
          <CardContent className="p-8">
            ...
            <Alert className="mt-8 bg-gradient-to-r from-purple-50 to-indigo-50 border-purple-300">
          ...
          {COMING_SOON_FEATURES.filter(f => f.id !== 'forger').map(feature => {
            ...
            return (
              <Card key={feature.id} className="border-none shadow-lg hover:shadow-xl transition-shadow">
                <CardHeader className={`p-6 bg-gradient-to-br ${feature.color} text-white`}>
        ...
        {/* Feedback CTA */}
        <Card className="mt-12 border-none shadow-xl bg-gradient-to-br from-blue-50 to-indigo-50">
