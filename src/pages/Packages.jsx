    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 p-6 md:p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl flex items-center justify-center">
        ...
        <Tabs defaultValue="subscriptions" className="w-full">
          ...
          <TabsContent value="subscriptions">
              ...
              {subscriptionPlans.map((pkg, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <CardHeader className={`p-6 bg-gradient-to-br ${pkg.color} text-white rounded-t-lg`}>
            ...
            {billingCycle === 'annual' && (
              <div className="mt-12 text-center p-8 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border-2 border-green-300 max-w-5xl mx-auto">
          ...
          <TabsContent value="subjects">
            ...
            <Card className="max-w-4xl mx-auto mb-12 border-4 border-purple-500 shadow-2xl">
              ...
              <CardContent className="p-8">
                ...
                <Button
                  ...
                  className="w-full h-16 text-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700"
                >
            ...
            <Card className="mt-12 max-w-4xl mx-auto bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200">
              <CardHeader>
              ...
              {bootcampPackages.map((pkg) => {
                ...
                return (
                  ...
                  >
                    ...
                    <CardHeader className="p-6 bg-gradient-to-br from-purple-600 to-indigo-600 text-white rounded-t-lg">
                      <div className="flex items-center justify-center mb-3">
                        <Icon className="w-10 h-10" />
                      </div>
                      <CardTitle className="text-xl font-bold text-center mb-2">
              ...
              {simulatorPackages.map((pkg) => {
                ...
                return (
                  ...
                  >
                    ...
                    <CardHeader className="p-6 bg-gradient-to-br from-slate-800 to-slate-900 text-white rounded-t-lg">
                      <div className="flex items-center justify-center mb-3">
                        <Icon className="w-10 h-10" />
                      </div>
                      <CardTitle className="text-xl font-bold text-center mb-2">
        ...
        {/* CTA Section */}
        <div className="text-center mt-16 p-12 bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl text-white">
