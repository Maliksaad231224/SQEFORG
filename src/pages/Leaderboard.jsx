...
export default function Leaderboard() {
  ...
  const getUserAvatar = (user) => {
    ...
    return (
      <div className={`w-12 h-12 rounded-full bg-gradient-to-br ${PROFILE_COLORS[colorScheme]} flex items-center justify-center text-white font-bold text-lg`}>
        {initial}
      </div>
    );
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 p-6 md:p-10">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {currentUserRank && user && (
          <Card className="mb-6 border-none shadow-lg bg-gradient-to-r from-purple-50 to-blue-50">
        ...
        {/* Hall of Fame - Top 3 */}
        {users.length >= 3 && (
          <Card className="mt-6 border-none shadow-lg bg-gradient-to-br from-amber-50 to-yellow-50">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
